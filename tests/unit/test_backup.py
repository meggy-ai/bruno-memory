...
from bruno_memory.utils.backup import BackupExporter, quick_export_to_csv, quick_backup
...
class TestBackupExporter:
    ...
    def test_custom_filename(self, exporter, sample_messages, tmp_path):
        ...
        output_file = exporter.export_messages_to_json(
            sample_messages,
            str(custom_file)
        )
