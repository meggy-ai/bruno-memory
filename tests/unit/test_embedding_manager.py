...
from bruno_memory.managers.embedding import EmbeddingManager, EmbeddingCache
...
class TestEmbeddingManager:
    ...
    async def test_embed_message_with_metadata(self, embedding_manager):
        ...
        embedding = await embedding_manager.embed_message(
            message_content,
            metadata=metadata
        )
    ...
    async def test_embed_memory(self, embedding_manager):
        ...
        embedding = await embedding_manager.embed_memory(
            memory_content,
            memory_type
        )
