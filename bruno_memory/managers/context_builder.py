...
from bruno_core.models import Message, ConversationContext, MessageRole
...
class HybridStrategy(BaseContextStrategy):
    ...
    async def select_messages(
        ...
        **kwargs
        ...
        recent_messages = await recent_strategy.select_messages(
            messages, 
        ...
        important_messages = await importance_strategy.select_messages(
            messages,
            max_messages=max_messages - len(recent_messages) if max_messages else 10
        )
