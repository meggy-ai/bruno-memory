...
Summary:"""
    ...
    def _format_messages(messages: List[Message]) -> str:
        ...
        lines = []
        for msg in messages:
            role_name = msg.role.value.upper() if isinstance(msg.role, MessageRole) else str(msg.role).upper()
...
class MemoryCompressor:
    ...
    async def get_compression_stats(self, conversation_id: UUID) -> Optional[Dict[str, Any]]:
